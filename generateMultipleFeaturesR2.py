...
feature_codes = ['spec_pow', 'spec_phs', 'num_of_peaks', 'slope', 'total_var'] #also mean, std, kurtosis, 'slope', 'num_of_peaks', 'total_var', 'spec_phs'
...
readFromHigherResolutionSignalQ = False
higherSamplingFreqAndFolderExtension = 0 #notused now 128 afterwards
                ...
                for index in range(6):
                    ...
                    for feat in feature_types:
                        for coeff_type in coeff_types:
                            ...
                            fName = outputFolder + selectedContent + '/' + sensors[sensorID][0] + "/" + feat + '/' + sensors[sensorID][0] + ' ' + signalName + ' ' + feat + ' ' + coeff_type  
