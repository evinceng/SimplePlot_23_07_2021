...
def createFiguresForAll(pictOutputFolder, selectedFactor, contentID, sensors, userSensorContentFileName, factorScoresFileName):
    for sensorID, sensor in sensors.items():
        ...
        filteredUserList = getUsersSignalsOfOneContent(userSensorContentFileName, sensorID, contentID)
        print(filteredUserList)
        lowFactorUserIDs, highFactorUserIDs = getLowAndHighFactorUserIDS(filteredUserList, factorScoresFileName, selectedFactor)
...
createFiguresForAll(pictOutputFolder, 'F1', 'C1', sensors, userSensorContentFileName, factorScoresFileName)                                                   
